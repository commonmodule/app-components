...
function generateColors(numFromName: number, colors: string[]) {
...
export default class DefaultAvatar extends DomNode {
  ...
  <g mask="url(#${maskId})">
    ...
    <path filter="url(#filter_${maskId})" d="M32.414 59.35L50.376 70.5H72.5v-71H33.728L26.5 13.381l19.057 27.08L32.414 59.35z" fill="${
        properties[1].color
      }" transform="${
        "translate(" +
    ...
    <path filter="url(#filter_${maskId})" d="M22.216 24L0 46.75l14.108 38.129L78 86l-3.081-59.276-22.378 4.005 12.972 20.186-23.35 27.395L22.215 24z" fill="${
        properties[2].color
      }" transform="${
        "translate(" +
