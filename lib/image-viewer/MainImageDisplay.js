...
export default class MainImageDisplay extends Dom {
    ...
    constructor(options) {
        ...
        AppRoot.bind("mousemove", this, (event) => this.drag(event));
        AppRoot.bind("mouseup", this, () => this.endDrag());
        this.currentImage.on("touchstart", (event) => this.startTouch(event));
        AppRoot.bind("touchmove", this, (event) => this.moveTouch(event));
        AppRoot.bind("touchend", this, (event) => this.endTouch(event));
