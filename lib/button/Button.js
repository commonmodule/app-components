...
export default class Button extends DomNode {
    ...
    constructor(classNamesOrOptions, optionsOrUndefined) {
        ...
        if (options.iconPosition === "right") {
            this.append(this.titleContainer = el(".title", ...(typeof options.title === "string" || !options.title
                ? [options.title]
            ...
            this.append(options.icon
                ...
                : undefined, this.titleContainer = el(".title", ...(typeof options.title === "string" || !options.title
                ? [options.title]
                : options.title)));
        }
    ...
    set title(title) {
        this.titleContainer.clear().append(...(typeof title === "string" ? [title] : title));
    }
    get title() {
